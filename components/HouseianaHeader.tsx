...
export default function HouseianaHeader({
  ...
  const guestMenuItems = [
    { type: 'link', label: 'Dashboard', href: '/client-dashboard', icon: LayoutDashboard },
    { type: 'link', label: 'Wishlists', href: '/wishlists', icon: Heart },
    { type: 'divider' },
    ...(isHost ? [
      { type: 'switch', label: 'Switch to hosting', icon: ArrowLeftRight, highlight: true },
    ] : [
      { type: 'link', label: 'List your home', href: '/host-dashboard/add-listing', icon: Building2, highlight: true },
    ]),
    { type: 'divider' },
    { type: 'link', label: 'Account', href: '/account', icon: UserCircle },
    { type: 'link', label: 'Help Center', href: '/help', icon: HelpCircle },
    { type: 'divider' },
    { type: 'link', label: 'Log out', href: '/sign-out', icon: LogOut },
  ];

  const hostMenuItems = [
    { type: 'link', label: 'Dashboard', href: '/host-dashboard', icon: LayoutDashboard },
    { type: 'link', label: 'Listings', href: '/host-dashboard/listings', icon: Building2 },
    { type: 'link', label: 'Reservations', href: '/host-dashboard/bookings', icon: CalendarDays },
    { type: 'link', label: 'Earnings', href: '/host-dashboard/earnings', icon: DollarSign },
    { type: 'link', label: 'Reviews', href: '/host-dashboard/reviews', icon: Star },
    { type: 'divider' },
    { type: 'switch', label: 'Switch to traveling', icon: ArrowLeftRight, highlight: true },
    { type: 'divider' },
    { type: 'link', label: 'Create a new listing', href: '/host-dashboard/add-listing', icon: Plus },
    { type: 'divider' },
    { type: 'link', label: 'Account', href: '/account', icon: UserCircle },
    { type: 'link', label: 'Help Center', href: '/help', icon: HelpCircle },
    { type: 'divider' },

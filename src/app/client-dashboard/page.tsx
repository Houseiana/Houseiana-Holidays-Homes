...
import {
  ...
  MessageCircle, Settings, Calendar, MapPin, Award,
  CreditCard, Shield, Bell, HelpCircle, FileText
} from 'lucide-react';
import HouseianaHeader from '@/layout/Navbar/HouseianaHeader';
import { useClientDashboard, Trip, Wishlist, Message, DashboardTab, TripFilter } from '@/hooks';
...
function TripCard({ trip, formatDate, calculateNights, onPayBalance, onClick }: TripCardProps) {
  return (
    <div
...
function MessageItem({ message, isLast, onClick }: MessageItemProps) {
  return (
    <div
...
function AccountCard({ icon, title, description, onClick }: AccountCardProps) {
  return (
    <div

...
export default function PropertyDetailPage() {
  ...
  useEffect(() => {
    ...
    setDefaultDates()
  }, [params.id, loadProperty, setDefaultDates])
  ...
  const prevImage = () => {
    setSelectedImageIndex((prev) => (prev > 0 ? prev - 1 : (property?.images.length || 1) - 1))
  }

  const nextImage = () => {
    setSelectedImageIndex((prev) => (prev < (property?.images.length || 1) - 1 ? prev + 1 : 0))
  }

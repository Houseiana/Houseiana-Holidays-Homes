...
import { DashboardStatSkeleton, TableRowSkeleton } from '@/components2/ui/loaders/loading-skeleton';
import { NoPropertiesEmptyState } from '@/components2/common/empty-states/empty-state';

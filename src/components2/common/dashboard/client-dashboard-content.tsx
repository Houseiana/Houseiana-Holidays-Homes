...
import { BookingCardSkeleton } from '@/components2/ui/loaders/loading-skeleton';
import { NoTripsEmptyState, NoFavoritesEmptyState, PastTripsEmptyState } from '@/components2/common/empty-states/empty-state';

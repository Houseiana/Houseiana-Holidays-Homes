...
export default function LoginSecurityPage() {
  ...
  const hasAppleAccount = connectedAccounts.some(acc => acc.provider === 'apple');
                  ...
                  <div>
                    ...
                    {hasGoogleAccount ? (
                      <p className="text-gray-500 text-sm">
                        {connectedAccounts.find(acc => acc.provider === 'google')?.emailAddress}
                      </p>
                    ) : (
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    {hasAppleAccount ? (
                      <p className="text-gray-500 text-sm">
                        {connectedAccounts.find(acc => acc.provider === 'apple')?.emailAddress}
                      </p>
                    ) : (
                      <p className="text-gray-400 text-sm">Not connected</p>
                    )}

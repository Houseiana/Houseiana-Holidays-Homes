    ...
    try {
      ...
      if (clerkUser) {
        ...
        try {
          ...
          throw clerkError // Re-throw to show error to user
        }
      }
                            ...
                            {isEditingBasicInfo ? (
                              <div className="flex gap-2">
                                <select
                                  ...
                                  className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent w-32"
                                >
